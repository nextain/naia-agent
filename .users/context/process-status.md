...
- 상태: P01~P03 정본 고정, P04 구현 전 계획 리뷰 진행 중 (`REQ-022 / UC-ORCH-002`)
...
- P04: 대기 — SQLite 세션 저장소, 전역 scheduler-owner lease가 지키는 bounded FIFO 스케줄러,
  actor 호출 전 issue ensure/link, REQ-021 실행 포트/어댑터, 결정론적 통합·레이어 경계 테스트와 무과금 벤치.
