...
| **`packages/memory/`** (신설) | — | naia-memory adapter |
...
| 5 | **Adapter pattern** — opencode/claude-code (및 향후 adapter) 모두 동일 interface 사용. 새 sub-agent = adapter 1개. | adapter contract test |
