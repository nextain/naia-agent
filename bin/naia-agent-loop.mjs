...
const HELP = `naia-agent loop — durable hybrid coding-session manager
...
The config pins state/workspace/worktree roots, a Codex Luna moderator, Azure-backed Pi roles, checks, concurrency,
