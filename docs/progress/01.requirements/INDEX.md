...
| REQ-022 | wire 어휘 동기 | 셸과 뇌가 주고받는 메시지 종류와 환경 세그먼트 kind 는 한쪽이 조용히 바꿀 수 없다. 두 저장소가 같은 표본을 들고 각자 자기 코드에서 어휘를 뽑아 대조하고, 짝 저장소를 못 찾으면 건너뛰지 않고 실패한다. #113 은 이 게이트가 없어서 8주간 안 보였다. | Done | UC-025 | SPEC-021 | TEST-S-025 |
