...
| TEST-S-015 | UC-015 | DJ/전시 profile 계약·gRPC 통합은 멘트/소개·제어·yield/resume·race를 검증. shell 실제 Tauri는 profile 저장·복원, DJ 실제 BGM·첫 결과·stop, 전시 greeting·stop만 검증 | 계약+통합+부분 native | `src/test/{personal-radio-dj,exhibition-intro}.contract.test.ts`, `src/test/personal-radio-dj-grpc.integration.test.ts`, shell `e2e-tauri/specs/71-proactive-speech-profiles.spec.ts` | Partial |
