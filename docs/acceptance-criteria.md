...
## Issue #82 선제 발화 증거 경계

| 흐름 | agent 계약/통합 | 실제 Tauri | 제품/현장 |
|---|:---:|:---:|:---:|
| profile 저장·복원 | ✅ | ✅ | 미검증 |
| DJ 실제 YouTube BGM·첫 결과·stop | ✅ | ✅ | 미검증 |
| 전시 greeting·stop | ✅ | ✅ | 미검증 |
| DJ 멘트2·모든 제어·live 끼어들기 | ✅ | 미검증 | 미검증 |
| 전시 질문 중단→답변→resume·stale 폐기 | ✅ | 미검증 | 미검증 |
| audible proactive TTS·장시간 품질 | seam 계약 | 미검증 | 미검증 |
| 기분/활동·날씨 UI·Naia Memory 음악 선호 | 미배선 | 미검증 | 미검증 |

실제 Tauri 테스트는 TTS를 끄고 실행한다. 따라서 이 표의 실제 Tauri 열보다 넓은 완료 주장을 하지
않는다. 남은 product wiring과 live acceptance는 `nextain/naia-agent#84`에서 추적한다.
