...
const trackedInputs = ["benchmark/run-issue-team-deterministic.mjs", "benchmark/orchestration/issue-team-deterministic.json",
  ...
  "src/main/adapters/subagent-opencode-cli.ts", "src/main/domain/issue-team.ts",
...
try {
  ...
  const adapterReadOnlyEnforced = await observeAdapterReadOnlyBoundary(makePiSubAgent, makeOpencodeSubAgent);
  ...
  const runtimeModules = ["main/app/issue-team-worker.js", "main/adapters/sqlite-issue-team-store.js", "main/adapters/subagent-pi.js",
    "main/adapters/subagent-opencode-cli.js", "main/domain/issue-team-benchmark.js", "main/composition/supervised-issue-worker.js"];
...
async function observeAdapterReadOnlyBoundary(makePi, makeOpencode) {
